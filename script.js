...
"CrimesContraADM":[
{
  ...
  {
    "question": "(FCC – 2014 – TRF3 – TÉCNICO JUDICIÁRIO) Na corrupção passiva, há diferenciações normativas se: - em consequência da vantagem ou promessa, o funcionário retarda ou deixa de praticar qualquer ato de ofício ou o pratica infringido dever funcional - o funcionário pratica, deixa de praticar ou retarda ato de ofício, com infração de dever funcional, cedendo a pedido ou influência de outrem. Tem-se, nesses dois fatores de penas, respectivamente:",
    "options": [
  ...
  {
    "question": "(FCC – 2014 – ICMS/RJ – AUDITOR FISCAL) A conduta do funcionário que exige tributo ou contribuição social que sabe ou deveria saber indevido, ou, quando devido, emprega na cobrança meio vexatório ou gravoso, que a lei não autoriza, configura",
    "options": [
  ...
  {
    "question": "(FCC – 2014 – TCE-GO – ANALISTA DE CONTROLE EXTERNO) Paulo ofereceu R$ 300,00 a um Oficial de Justiça para retardar a sua citação. O Oficial de Justiça aceitou a oferta, mas achou o valor oferecido muito baixo, tendo Paulo ficado de estudar eventual majoração. Nesse caso, o Oficial de Justiça cometeu crime de",
    "options": [
  ...
  {
    "question": "(FCC – 2014 – TCE-GO – ANALISTA DE CONTROLE EXTERNO) No que concerne ao crime de peculato doloso, é correto afirmar que",
    "options": [
  ...
  {
    "question": "(FCC – 2015 – TRT6º REGIÃO – JUIZ) O crime de concussão",
    "options": [
  ...
  {
    "question": "(FCC – 2015 – SEFAZ-PI – ANALISTA DO TESOURO) No crime de concussão, o funcionário público",
    "options": [
  ...
  {
    "question": "(FCC – 2015 – SEFAZ-PI – AUDITOR FISCAL) O crime de inserção de dados falsos em sistema de informações (art. 313-A do Código Penal) pode ser cometido",
    "options": [
  ...
  {
    "question": "(FCC - 2008 - METRÔ-SP – ADVOGADO) Durante um julgamento perante o Tribunal do Júri, um jurado, que em sua vida normal exerce a função de vendedor, solicitou R$ 10.000,00 (dez mil reais) ao advogado do réu para votar pela absolvição deste. O jurado",
    "options": [
  ...
  {
    "question": "(FCC - 2007 - MPU - ANALISTA – PROCESSUAL) A respeito dos crimes contra a Administração Pública, é correto afirmar:",
    "options": [
  ...
  {
    "question": "(FCC - 2010 - DPE-SP - AGENTE DE DEFENSORIA - COMUNICAÇÃO SOCIAL) Determinado servidor público destruiu livro oficial a fim de ocultar lançamento que procedeu indevidamente. A conduta do servidor, a ser apurada e punida mediante instauração dos competentes processos pertinentes,",
    "options": [
  ...
  },
  {
    ...
    "options": [
      ...
      "eles responderão pela prática de crime de peculato consumado em concurso de pessoas.",
  ...
  {
    "question": "(FCC - 2007 - TRF-4R - ANALISTA JUDICIÁRIO - ÁREA JUDICIÁRIA - EXECUÇÃO DE MANDADOS) Dar às verbas ou às rendas públicas aplicação diversa da estabelecida em lei",
    "options": [
  ...
  {
    "question": "(FCC - 2006 - TRT-24R - ANALISTA JUDICIÁRIO - ÁREA JUDICIÁRIA) Ares, funcionário do Serviço de Águas e Esgotos do Município, entidade paraestatal, desviou em proveito próprio a quantia de R$ 5.200,00 referente ao pagamento de contas em atraso efetuadas por um usuário. Nessa hipótese, Ares",
    "options": [
  ...
  {
    "question": "(FCC - 2013 – ASSEMBLEIA LEGISLATIVA/PB - PROCURADOR) O funcionário público que, se valendo dessa qualidade, patrocina interesse privado perante a administração pública comete, em princípio, o crime de",
    "options": [
      "corrupção passiva.",
      "condescendência criminosa.",
      "advocacia administrativa.",
  ...
  {
    "question": "(FCC - 2013 - DPE-SP - OFICIAL DE DEFENSORIA PÚBLICA) Guilhermino, funcionário público estadual estável, exige de Gabriel tributo que sabe ser indevido aproveitando-se da situação de desconhecimento do cidadão. Neste caso, segundo o Código Penal brasileiro, Guilhermino praticou crime de",
    "options": [
      "peculato culposo.",
      "peculato doloso.",
      "excesso de exação.",
  ...
  {
    "question": "(FCC - 2013 - DPE-SP - OFICIAL DE DEFENSORIA PÚBLICA) Matias, diretor da Penitenciária XYZ, permite livremente o acesso de aparelho telefônico celular dentro da Penitenciária que dirige, o que está permitindo a comunicação dos presos com o ambiente externo. Neste caso, Matias",
    "options": [
  ...
  {
    "question": "(FCC - 2013 - TJ-PE - TITULAR DE SERVIÇOS DE NOTAS E DE REGISTROS - PROVIMENTO) Modela-se também pelas ideias de furto e de apropriação indébita a figura legal do crime de",
    "options": [
      "prevaricação.",
      "concussão.",
      "excesso de exação.",
  ...
  {
    "question": "(FCC - 2013 - TJ-PE - TITULAR DE SERVIÇOS DE NOTAS E DE REGISTROS - PROVIMENTO) A exigência de vantagem indevida para si, em razão do exercício de função pública, caracteriza crime de",
    "options": [
      "concussão.",
      "corrupção passiva.",
      "corrupção ativa.",
  ...
  {
    "question": "(FCC – 2012 – MPE-SE – TÉCNICO MINISTERIAL) O tipo do art. 320 do Código Penal (Condescendência criminosa) está assim redigido: “Deixar o funcionário, por indulgência, de responsabilizar subordinado que cometeu infração no exercício do cargo ou, quando lhe falte competência, não levar o fato ao conhecimento da autoridade competente”. No que concerne ao fato típico, a expressão “por indulgência” corresponde",
    "options": [
      "ao resultado.",
      "à ação.",
  ...
  {
    "question": "(FCC – 2012 – MPE-SE – TÉCNICO MINISTERIAL) O funcionário público que, embora não tendo a posse do dinheiro, valor ou bem, o subtrai, em proveito próprio ou alheio, valendo-se de facilidade que lhe proporciona a qualidade de funcionário:",
    "options": [
  ...
  {
    "question": "(FCC – 2012 – TJ-PE – TÉCNICO JUDICIÁRIO) Tecius, funcionário público municipal, apropriou-se de remédios doados por um laboratório farmacêutico ao Posto de Saúde do qual era médico chefe, e os levou ao seu consultório particular, vendendo-os a seus clientes. Tecius, além de outras infrações legais,",
    "options": [
  ...
  {
    "question": "(FCC – 2012 – TJ-PE – TÉCNICO JUDICIÁRIO) Rodrigues, funcionário público lotado em repartição fiscal, emprestou sua senha a um amigo estranho ao serviço público, possibilitando-lhe acesso ao banco de dados da Administração Pública, para fins de obtenção de lista de contribuintes e envio de material publicitário. Nesse caso, Rodrigues responderá por crime de",
    "options": [
      "tráfico de influência.",
      "condescendência criminosa.",
      "excesso de exação.",
  ...
  {
    "question": "(VUNESP – 2009 – TJ/SP – ENFERMEIRO JUDICIÁRIO) Se uma professora da rede pública de ensino, em razão de uma falha no sistema bancário, recebe um salário maior do que o que lhe é devido, e intencionalmente não devolve o dinheiro aos cofres públicos,",
    "options": [
  ...
  {
    "question": "(VUNESP – 2009 – TJ/SP – ENFERMEIRO JUDICIÁRIO) Para que o crime de prevaricação em umas das suas formas legais reste configurado, é preciso que o funcionário público",
    "options": [
  ...
  {
    "question": "(VUNESP – 2009 – TJ/SP – ENFERMEIRO JUDICIÁRIO) Condescendência criminosa",
    "options": [
  ...
  {
    "question": "(VUNESP – 2009 – TJM/SP – ESCREVENTE TÉCNICO JUDICIÁRIO) O crime de falsidade ideológica, presentes os demais elementos legais, apenas se configura se I. o documento é público, não havendo crime se o documento é particular; II. ocorre a inserção de declaração falsa, não havendo crime se ocorre a omissão de declaração verdadeira relevante; III. o agente é funcionário público, não havendo crime se a conduta é praticada por particular. Assinale a alternativa que classifica corretamente, como verdadeiros (V) ou falsos (F), os itens que completam a proposição, de acordo com o art. 299 do CP.",
    "options": [
      "I - F; II - F; III - F.",
      "I - V; II - F; III - F.",
      "I - V; II - V; III - F.",
  ...
  {
    "question": "(Vunesp – 2011 – TJM/SP – escrevente técnico judiciário) No crime de concussão (CP, art. 316), o agente ______________, para si ou para outrem, direta ou indiretamente, ainda que fora da função ou antes de assumi-la, mas em razão dela, vantagem indevida. Assinale a alternativa que completa corretamente a lacuna do texto.",
    "options": [
      "aufere",
      "exige",
      "recebe",
  ...
  {
    "question": "(Vunesp – 2011 – TJM/SP – oficial de justiça) Assinale a alternativa que completa, correta e respectivamente, as lacunas, no que concerne ao crime deadvocacia administrativa, do art. 321 do CP: \"Patrocinar, ______________, interesse_____________ perante a administração pública, valendo-se da qualidade de funcionário.\"",
    "options": [
      "diretamente ... próprio",
  ...
  {
    "question": "(VUNESP – 2011 – TJM/SP – OFICIAL DE JUSTIÇA) No crime de corrupção passiva (CP, art. 317), o agente ____________, para si ou para outrem, direta ou indiretamente, ainda que fora da função ou antes de assumi-la, mas em razão dela, vantagem indevida. Assinale a alternativa que completa corretamente a lacuna do texto.",
    "options": [
      "exige ou ordena",
      "solicita ou recebe",
      "recebe ou adquire",
  ...
  {
    "question": "(VUNESP – 2012 – TJM/SP – ESCREVENTE TÉCNICO JUDICIÁRIO) A conduta do funcionário público que, antes de assumir a função, mas em razão dela, exige para outrem, indiretamente, vantagem indevida",
    "options": [
  ...
  {
    "question": "(VUNESP - 2013 - ITESP - ADVOGADO) O fazendeiro de uma cidade do interior de São Paulo, que solicita aos assentados dinheiro a pretexto de influir na atuação de funcionário do ITESP a fim de facilitar a concessão de títulos de domínio visando a regularização fundiária, comete o crime de:",
    "options": [
  ...
  {
    "question": "(VUNESP - 2013 - ITESP - ADVOGADO) Policiais Militares Ambientais comparecem a um assentamento e constatam a extração ilegal de madeira (crime ambiental). Trabalhadores assentados pedem aos policiais que não adotem providências, no que são prontamente atendidos e os policiais se retiram, sem que qualquer providência fosse implementada. Diante da afirmação anterior, e com relação aos crimes contra a Administração Pública, os Policiais Militares cometeram o crime de:",
    "options": [
  ...
  {
    "question": "(VUNESP - 2013 - TJ-SP - MÉDICO JUDICIÁRIO - CLÍNICO GERAL) Agamenon, funcionário público, teve desavenças pessoais no trabalho contra Pitágoras. Com o desejo de vingar-se do seu desafeto, Agamenon retarda indevidamente um ato de ofício que devia praticar, com o claro objetivo de prejudicar Pitágoras. Conforme o que dispõe o Código Penal, essa conduta de Agamenon caracteriza o crime de",
    "options": [
      "corrupção passiva.",
      "descaminho.",
      "concussão.",
  ...
  {
    "question": "(VUNESP - 2013 - PC-SP - AGENTE DE POLÍCIA) O funcionário público que se apropria de dinheiro de que tem a posse em razão do cargo comete o crime de",
    "options": [
      "furto qualificado.",
      "peculato.",
      "roubo.",
  ...
  {
    "question": "(VUNESP - 2013 - PC-SP - AGENTE DE POLÍCIA) Nos crimes praticados por funcionário público contra a Administração Pública em geral, conforme previsto no Código Penal, se o autor do crime for ocupante de cargo em comissão ou de função de direção ou assessoramento de órgão da administração direta,",
    "options": [
  ...
  {
    "question": "(VUNESP - 2013 - PC-SP - PERITO CRIMINAL) Em relação ao crime de Advocacia Administrativa, é correto afirmar que",
    "options": [
  ...
  {
    "question": "(VUNESP – 2015 – PC/CE – ESCRIVÃO - ADAPTADA) Aquele que exclui indevidamente dados corretos nos sistemas informatizados ou bancos de dados da Administração Pública, com o fim de obter vantagem indevida para outrem, pratica o crime de inserção de dados falsos em sistemas de informações.",
    "options": [
      "CORRETA",
      "ERRADA"
    ],
  ...
  {
    "question": "(VUNESP – 2015 – PC/CE – ESCRIVÃO - ADAPTADA) O funcionário que modifica ou altera sistema de informações ou programa de informática sem autorização ou solicitação de autoridade competente pratica o crime de inserção de dados falsos em sistemas de informações.",
    "options": [
      "CORRETA",
      "ERRADA"
    ],
  ...
  {
    "question": "(VUNESP – 2015 – PC/CE – ESCRIVÃO - ADAPTADA) Receber, solicitar ou exigir para si ou para outrem, direta ou indiretamente, ainda que fora da função ou antes de assumi-la, mas em razão dela, vantagem indevida, tipifica o crime de concussão.",
    "options": [
      "CORRETA",
      "ERRADA"
    ],
  ...
  {
    "question": "(VUNESP – 2015 – PC/CE – ESCRIVÃO - ADAPTADA) Abandonar cargo público, fora dos casos permitidos em lei, só tipificará o crime de abandono de função se resultar prejuízo público.",
    "options": [
      "CORRETA",
      "ERRADA"
    ],
  ...
  {
    "question": "(FCC – 2018 – DPE-AM – ANALISTA) Quanto aos crimes praticados por funcionário público contra a Administração em geral, há no Código Penal brasileiro a previsão expressa da forma culposa para o crime de",
    "options": [
      "concussão.",
      "peculato.",
      "corrupção passiva.",
  ...
  {
    "question": "(FCC – 2017 – TRF5 – ANALISTA JUDICIÁRIO) Não é considerado funcionário público, ainda que por extensão, para os efeitos penais o",
    "options": [
  ...
  {
    "question": "(FCC – 2016 – TRF3 – ANALISTA JUDICIÁRIO) Lucius, funcionário público, escrevente de cartório de secretaria de Vara Criminal, apropriou-se de um relógio valioso que foi remetido ao Fórum juntamente com os autos do inquérito policial no qual foi objeto de apreensão. Lucius cometeu crime de",
    "options": [
      "apropriação de coisa achada.",
  ...
  {
    "question": "(FCC – 2016 – TRF3 – ANALISTA JUDICIÁRIO) Penélope, funcionária pública, recebeu doações de roupas feitas para a Secretaria de Assistência Social, local em que exercia as suas funções, destinadas a campanha de solidariedade, para serem distribuídas a pessoas pobres. De posse dessas mercadorias, apropriou-se de várias peças. Nesse caso, Penélope",
    "options": [
  ...
  {
    "question": "(FCC – 2016 – TRF3 – ANALISTA JUDICIÁRIO) Cicerus, funcionário público, exercia suas funções na Circunscrição de Trânsito e recebeu quantia em dinheiro de uma autoescola para aprovação e fornecimento de carteira de habilitação aos candidatos nela matriculados, sem os necessários exames. Cicerus cometeu crime de",
    "options": [
      "concussão.",
      "corrupção ativa.",
      "prevaricação.",
  ...
  {
    "question": "(FCC – 2016 – TRF3 – TÉCNICO JUDICIÁRIO) É punível na forma culposa o delito de",
    "options": [
      "abandono de função.",
      "peculato.",
      "violação de sigilo funcional.",
  ...
  {
    "question": "(FCC – 2015 – TCM-GO – AUDITOR) O crime de",
    "options": [
  ...
  {
    "question": "(FCC – 2015 – TCM-GO – AUDITOR) Cláudio, agente fiscal de rendas, constatou sonegação de impostos por parte da empresa Alpha. No entanto, deixou de autuá-la, retardando a prática do ato de ofício, por ser amigo do sócio administrador da empresa. Porém, outro fiscal, sabendo do ocorrido, foi até a empresa e lavrou o auto de infração. Nesse caso, Cláudio",
    "options": [
  ...
  {
    "question": "(FCC - 2015 - SEFAZ/PI – AUDITOR FISCAL DA FAZENDA ESTADUAL) Comete crime de",
    "options": [
  ...
  {
    "question": "(FCC – 2015 – TRE/SE – ANALISTA JUDICIÁRIO – ÁREA ADMINISTRATIVA) Patricio, funcionário público, atuando em um cartório de determinada Zona Eleitoral do Estado de Sergipe, exige a quantia de R$ 50.000,00 em dinheiro de Ourives, candidato a Vereador em um pleito eleitoral, para não formalizar a apreensão de material de propaganda irregular e compra de votos promovida por meio de entrega de cestas básicas a populares do município, tudo praticado durante o período eleitoral. Neste caso, o funcionário público Patrício cometeu crime de",
    "options": [
      "corrupção passiva.",
      "excesso de exação.",
      "concussão.",
  ...
  {
    "question": "(FCC – 2015 – TRE-PB – ANALISTA JUDICIÁRIO – ÁREA ADMINISTRATIVA) Ricardo, funcionário público da Prefeitura de Pedra Verde, patrocinou, indiretamente, no mês de Janeiro de 2015, interesse privado perante a Administração pública, valendo-se da qualidade de funcionário. Ricardo cometeu crime de:",
    "options": [
      "excesso de exação.",
      "peculato.",
      "corrupção passiva.",
  ...
  {
    "question": "(FCC – 2015 – TRT15 – JUIZ) No crime de peculato, a condição pessoal de funcionário público",
    "options": [
  ...
  {
    "question": "(FCC – 2015 – TRT9 – TÉCNICO JUDICIÁRIO) Sobre os crimes praticados por funcionário público contra a Administração em geral, é correto afirmar:",
    "options": [
...
,{
    "question": "(VUNESP – 2018 – PC-SP – AGENTE DE TELECOMUNICAÇÕES) O servidor público que exige para outrem, indiretamente, fora da função, mas em razão dela, vantagem indevida",
    "options": [
  ...
  {
    "question": "(VUNESP – 2018 – PC-BA - ESCRIVÃO) “Patrocinar, direta ou indiretamente, interesse privado perante a administração pública, valendo-se da qualidade de funcionário”. O tipo transcrito configura a infração penal comum denominada",
    "options": [
      "Advocacia Administrativa.",
      "Patrocínio Indébito.",
      "Tergiversação.",
  ...
  {
    "question": "(VUNESP – 2018 – TJ-SP – ESCREVENTE TÉCNICO JUDICIÁRIO) A respeito dos crimes praticados por funcionários públicos contra a administração pública, é correto afirmar que",
    "options": [
  ...
  {
    "question": "(VUNESP – 2017 – TJ SP – ESCREVENTE TÉCNICO JUDICIÁRIO) Funcionário público municipal, imprudentemente, deixa a porta da repartição aberta ao final do expediente. Assim agindo, mesmo sem intenção, concorre para que outro funcionário público, que trabalha no mesmo local, sub- traia os computadores que guarneciam o órgão público. O Município sofre considerável prejuízo. A conduta do funcionário que deixou a porta aberta traduz-se em",
    "options": [
  ...
  {
    "question": "(VUNESP – 2017 – TJ SP – ESCREVENTE TÉCNICO JUDICIÁRIO) Certos crimes têm suas penas estabelecidas em patamares superiores quando presentes circunstâncias que aumentam o desvalor da conduta. São os denominados “tipos qualificados”. Assinale a alternativa que indica o crime que tem como qualificadoras “resultar prejuízo público” e “ocorrer em lugar compreendido na faixa de fronteira”.",
    "options": [
      "Violência arbitrária.",
      "Abuso de poder.",
  ...
  {
    "question": "(VUNESP – 2017 – PREF. DE ANDRADINA – ASSESSOR JURÍDICO) A conduta de patrocinar indiretamente interesse privado perante a Administração Pública, valendo-se da sua qualidade de funcionário",
    "options": [
  ...
  {
    "question": "(VUNESP – 2014 – TJ-PA – AUXILIAR JUDICIÁRIO) “Solicitar ou receber, para si ou para outrem, direta ou indiretamente, ainda que fora da função ou antes de assumi-la, mas em razão dela, vantagem indevida, ou aceitar promessa de tal vantagem”. O tipo legal ora transcrito refere-se à descrição do delito de",
    "options": [
      "Corrupção Ativa.",
      "Concussão.",
      "Corrupção Passiva.",
  ...
  {
    "question": "(VUNESP – 2014 – TJ-PA – AUXILIAR JUDICIÁRIO) “Patrocinar, direta ou indiretamente, interesse privado perante a administração pública, valendo-se da qualidade de funcionário”. A conduta ora descrita, expressamente prevista no Código Penal, é denominada",
    "options": [
      "Favorecimento Pessoal.",
      "Advocacia Administrativa.",
      "Tergiversação.",
  ...
  {
    "question": "(VUNESP – 2014 – TJ-PA – ANALISTA JUDICIÁRIO) Concussão: ____________, para si ou para outrem,___________, ainda que fora da função ou antes de assumi-la, mas em razão dela, vantagem indevida. Assinale a alternativa que completa as lacunas adequada e respectivamente.",
    "options": [
      "receber ... diretamente",
  ...
  {
    "question": "(VUNESP – 2014 – TJ-PA – ANALISTA JUDICIÁRIO) Funcionário que deixa seus afazeres na repartição acumularem, pois se dedica a questões pessoais não urgentes durante o expediente de trabalho, sem autorização de seu superior, comete o crime de",
    "options": [
  ...
  {
    "question": "(VUNESP – 2014 – TJ-PA – ANALISTA JUDICIÁRIO) O crime de excesso de exação é cometido por",
    "options": [
  ...
  {
    "question": "(VUNESP – 2014 – TJ-SP – ESCREVENTE JUDICIÁRIO) Com relação aos crimes contra a Administração Pública, assinale a alternativa correta.",
    "options": [
  ...
  {
    "question": "(VUNESP – 2014 – TJ-SP – ESCREVENTE JUDICIÁRIO) Assinale a alternativa correta em relação a funcionário público de acordo com o Código Penal.",
    "options": [
  ...
  {
    "question": "(VUNESP – 2014 – TJ-SP – ESCREVENTE JUDICIÁRIO) Em relação ao crime de peculato, assinale a alternativa correta.",
    "options": [
      ...
      "Patrocinar o funcionário, indiretamente, interesse privado perante a Administração, valendo-se dessa qualidade."
    ],
    "correct": 0
  },
  {
    "question": "(VUNESP - 2013 - TJ-SP - ESCREVENTE TÉCNICO JUDICIÁRIO) Em relação ao crime de peculato, é correto afirmar:",
    "options": [
  ...
  {
    "question": "(VUNESP – 2015 – TJ-SP – ESCREVENTE JUDICIÁRIO) O peculato culposo",
    "options": [
  ...
  {
    "question": "(VUNESP – 2015 – TJ-SP – ESCREVENTE JUDICIÁRIO) O funcionário público que tem conhecimento de infração cometida no exercício do cargo por subordinado e que, por indulgência, não promove sua responsabilização e também não comunica o fato ao superior competente para tanto pratica",
    "options": [
  ...
  {
    "question": "(VUNESP – 2015 – PC-CE – DELEGADO DE POLÍCIA) Marcelo é aprovado em concurso público para o cargo de Delegado de Polícia. Sabe que seu vizinho tem expedido em seu desfavor mandado de prisão. Mesmo antes de assumir o cargo, Marcelo procura seu vizinho, que é proprietário de automóvel de luxo, e solicita-lhe comprar o veículo por 1/3 do preço de mercado, insinuando de modo implícito que caso a proposta não seja aceita efetuará sua prisão tão logo assuma o cargo público. O vizinho não cede e Marcelo, mesmo após assumir o cargo, não toma qualquer atitude em desfavor de seu vizinho. Marcelo praticou",
    "options": [
      "corrupção passiva.",
  ...
  {
    "question": "(VUNESP – 2012 – SEFAZ/SP – AGENTE FISCAL DE RENDAS) No crime de concussão, a circunstância de ser um dos agentes funcionário público:",
    "options": [
  ...
  {
    "question": "(VUNESP – 2010 – TJ/SP – ESCREVENTE TÉCNICO JUDICIÁRIO) Imagine que, por erro, um cidadão entrega a um funcionário público determinada quantia em dinheiro. O funcionário, ciente de tal circunstância, não devolve o dinheiro ao cidadão, não informa o ocorrido aos seus superiores e, finalmente, apropria-se do dinheiro. Diante disso, é correto afirmar que o funcionário",
    "options": [
  ...
  {
    "question": "(VUNESP – 2010 – TJ/SP – ESCREVENTE TÉCNICO JUDICIÁRIO) Configura-se o crime de advocacia administrativa (CP, art. 321) quando o funcionário público, valendo-se dessa qualidade, patrocina interesse privado perante a administração pública. Considerando tal crime, analise os itens seguintes: I. a pena cominada é menor se o interesse patrocinado for ilegítimo; II. o crime acontecerá ainda que o patrocínio se dê de modo indireto; III. se o interesse patrocinado é ilegítimo, as penas de detenção e multa aplicam-se alternativamente, ou seja, aplica-se a de detenção ou a de multa. É correto o que se afirma em",
    "options": [
      "II, apenas.",
      "III, apenas.",
      "I e II, apenas.",
  ...
  {
    "question": "(VUNESP – 2010 – TJ/SP – ESCREVENTE TÉCNICO JUDICIÁRIO) O crime de abandono de função, figura típica do art. 323 do Código Penal, torna-se qualificado – e consequentemente tem penas mais elevadas – se I. do fato resulta prejuízo público; II. o fato ocorre em lugar compreendido na faixa de fronteira; III. o agente realiza a conduta de forma premeditada. Está correto o contido em",
    "options": [
      "I, apenas.",
      "II, apenas.",
      "I e II, apenas.",
  ...
  {
    "question": "(VUNESP – 2011 – TJ/SP – ESCREVENTE TÉCNICO JUDICIÁRIO) A pena do crime de corrupção passiva é aumentada se o funcionário público, em consequência da vantagem ou promessa, infringe dever funcional I. retardando ou deixando de praticar qualquer ato de ofício; II. praticando qualquer ato de ofício; III. de forma intencional ou premeditada. É correto o que se afirma em",
    "options": [
      "I, apenas.",
      "II, apenas.",
      "III, apenas.",
  ...
  {
    "question": "(VUNESP – 2006 – TJ/SP – ESCREVENTE TÉCNICO JUDICIÁRIO) Determinado policial militar disse de forma impositiva ao assaltante que acabou de prender em flagrante, com o intuito de se locupletar indevidamente, que somente muito dinheiro o faria \"aliviar sua barra\". Tal conduta",
    "options": [
      "não tipifica crime.",
  ...
  {
    "question": "(VUNESP – 2006 – TJ/SP – ESCREVENTE TÉCNICO JUDICIÁRIO) \"X\", funcionário público, recebe indevidamente dinheiro da vítima que o supunha encarregado do recebimento de impostos atrasados. \"X\", em tese,",
    "options": [
  ...
  {
    "question": "(VUNESP – 2010 – TJ/SP – CIRURGIÃO DENTISTA JUDICIÁRIO) A conduta de exigir, para si ou para outrem, direta ou indiretamente, ainda que fora da função ou antes de assumi-la, mas em razão dela, vantagem indevida, quando praticada por funcionário público, caracteriza o crime de",
    "options": [
      "excesso de exação.",
      "corrupção passiva.",
      "prevaricação.",
  ...
  {
    "question": "(VUNESP – 2009 – TJ/SP – OFICIAL DE JUSTIÇA) O crime de peculato",
    "options": [
